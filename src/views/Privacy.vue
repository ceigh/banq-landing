...
<div class='container'>
  <div class='content'>
    ...
    <p class='date'>Федеральный закон от 27.07.2006</p>

    <div class='text'>
      <p class='heading'>1. Общие положения</p>
      ...
      <p class='text-block'>
        ...
        данных, предпринимаемые {{ url }} (далее – Оператор).
      </p>
      ...
      <p class='text-block'>
        ...
        Оператор может получить о посетителях веб-сайта {{ url }}.
      </p>

      <p class='heading'>2. Основные понятия, используемые в Политике</p>
      ...
      <p class='text-block'>
        ...
        в сети интернет по сетевому адресу {{ url }};
      </p>
      ...
      <p class='text-block'>
        2.9. Пользователь – любой посетитель веб-сайта {{ url }};
      </p>
      ...
      <p class='heading'>4. Цели обработки персональных данных</p>
      ...
      <p class='text-block'>
        ...
        электронной почты {{ email }} с пометкой «Отказ от уведомлений о
      ...
      <p class='text-block'>
        ...
        специальные формы, расположенные на сайте {{ url }}
      ...
      <p class='heading'>7. Трансграничная передача персональных данных</p>
      ...
      <p class='heading'>8. Заключительные положения</p>
      ...
      <p class='text-block'>
        ...
        к Оператору с помощью электронной почты {{ email }}.
      </p>
      ...
      <p class='text-block'>
        ...
        сети Интернет по адресу {{ url }}/privacy
      </p>
    </div>
  </div>
</div>
